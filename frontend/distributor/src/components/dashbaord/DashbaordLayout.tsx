...
const navItems: NavItem[] = [
  ...
  { name: 'Seller Orders', icon: Users, path: '/seller-orders' },
  { name: 'Request Stock', icon: ShoppingCart, path: '/place-order' },
  { name: 'My Requests', icon: Truck, path: '/orders' },
];

export const DashboardLayout: React.FC = () => {
  const { distributor, logout } = useAuth();
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center gap-3 mb-3">
              <Avatar><AvatarFallback className="bg-blue-900 text-white">{distributor ? getInitials(distributor.name) : 'D'}</AvatarFallback></Avatar>
